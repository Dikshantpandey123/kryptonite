...
//these methods are typically known as char driver methods/call backs !!!
//
...
static int __init plp_kmem_init(void)
{
	...
	//list_add_tail(&my_dev->list,&dev_list); //private list 
        ...
        // set to 0 !!!
        //first device id will be , in plp_kmem_dev, with minor 
        //part set to 0
        //
        //second device id will be , in plp_kmem_dev+1
        //third device id will be , in plp_kmem_dev+2
        //last device id  will be , in plp_kmem_dev+1 + ndevices -1 
...
//to manage module's resource usage count !!!
	...
	//ptr to cdev
        ...
        //added to a system data structure of char device 
        //layer/frame-work , which may be used, in 
        ...
        //help the system and device driver to manage our device !!!
